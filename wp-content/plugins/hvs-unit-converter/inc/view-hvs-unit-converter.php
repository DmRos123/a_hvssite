...
?>
        ...
        <form id="conversion-form" action="" method="POST">
            ...
            wp_nonce_field( 'hvs_unit_converter', 'hvs_unit_converter_form' );
            ?>
            
            <h4><?php _e( 'Unit Converter', 'hvs-unit-converter' ); ?></h4>
            
            <ol id="list-options">
                <li name="basic" value="0" class="convert-list-options <?= $list_choice == 'basic' ? ' active' : ''; ?>"><?php _e( 'Basic', 'hvs-unit-converter' ); ?></li>
                <li name="default" value="1" class="convert-list-options <?= $list_choice == 'default' ? ' active' : ''; ?>"><?php _e( 'Default', 'hvs-unit-converter' ); ?></li>
                <!--<li name="advanced" value="2" class="convert-list-options <?= $list_choice == 'advanced' ? ' active' : ''; ?>"><?php // _e( 'Advanced', 'hvs-unit-converter' ); ?></li>-->
            </ol>
            ...
            <div id="show-input-option" class="convert-list-options no-border">
                ...
                <label for="show_str_input"><?php _e( 'Show input field', 'hvs-unit-converter' ); ?></label>
            </div>
            
            <div id="conversion-type">
                <input type="text" id="convert_string" name="convert_string" value="<?= esc_attr( $convert_string ); ?>" placeholder="<?php _e( 'Format: X [units] to [units]', 'hvs-unit-converter' ); ?>">
            ...
            <div id="conversion-units">
                ...
                <span id="equal-sign"><?php _e( '=', 'hvs-unit-converter' ); ?></span>
            ...
            <div class="controls">
                <div class="convert-list-options no-border">
                    ...
                    <label for="show_all_units"><?php _e( 'Show ALL units', 'hvs-unit-converter' ); ?></label>
                </div>

                <div class="convert-list-options no-border right">
                    <input type="submit" name="submit" value="<?php _e( 'Convert', 'hvs-unit-converter' ); ?>">
                </div>
            </div>
